...
//         //target과 위치 같을 때 랜덤방향으로 가기 (Virtual)
//         // else{
...
//             while(GameMgr.currentMap.Map[_x,_y] != 0){
//                 // Debug.Log("RandomPositioning...");
//                 _x = UnityEngine.Random.Range(1, stageData.Limit);
//                 _y = UnityEngine.Random.Range(1, stageData.Limit);
//             }
...
//         if(GameMgr.currentMap.Map[p.x, p.y] == 1){
//             return false;
//         }
//         else return true;
...
//     protected virtual Vector2 Follow(List<Node> finalNodeList){
//         if(finalNodeList.Count != 0)
//         {
//             var m = new Vector2(finalNodeList[1].x, finalNodeList[1].y) - this.pos;
//             return m;
//         }
//         return Vector2.zero;
//     }
